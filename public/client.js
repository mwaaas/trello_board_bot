...
TrelloPowerUp.initialize({
  ...
  'attachment-sections': function(t, options){
    ...
    if(claimed && claimed.length > 0){
      ...
      return [{
        ...
        content: {
          type: 'iframe',
          url: t.signUrl('./section', { arg: 'you can pass your section args here' }),
          height: 230
        }
      }];
    } else {
  ...
  'show-authorization': function(t, options){
    ...
    return t.popup({
      title: 'My Auth Popup',
      url: './authorize', // this page doesn't exist in this project but is just a normal page like settings.html
      height: 140,
    });
  },
