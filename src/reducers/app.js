...
export const getSematextExperienceToken = state => state.get('sematextExperienceToken');
export const getSegmentWriteKey = state => state.get('segmentWriteKey');
