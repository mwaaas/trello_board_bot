...
export default class BlockSelectPlanModal extends Component {
  static propTypes = {
  ...
  componentDidMount() {
    ...
    this.props.trackEvent(
      organizationTypes.EVENTS.USER_PLAN_SELECTION_BLOCKED,
      {
...
// WEBPACK FOOTER //
// ./src/containers/PricingContainer/BlockSelectPlanModal.jsx